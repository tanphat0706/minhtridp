...
<div class="box box-primary">
    <!-- form start -->
    {!! Form::open(['route'=>['update-user-group', $userGroup->id], 'method'=> 'POST'])!!}
    <div class="box-body">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!!Form::text('name', $userGroup->name , array('class' => 'form-control formwidth', 'autocomplete' => 'off')) !!}
                </div>
            </div>
            <!-- /.col -->
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!!Form::text('note', $userGroup->note, array('class' => 'form-control formwidth', 'autocomplete' => 'off')) !!}
                </div>
            </div>
            <!-- /.col -->
        </div>
        ...
        @foreach ($roleGroups as $group)
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <label> {!!Form::checkbox( 'role[]', $role->code, $userGroupService->groupHasRole($userGroup->id, $role->code), array('class' => 'checkboxRole')) !!} {{ trans('role.'.$role->code) }} </label>
                    <br>
                    @endforeach
                </div>
            </div>
